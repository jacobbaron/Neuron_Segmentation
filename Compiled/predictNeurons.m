function [prediction,nmPeakSigMatTest]=predictNeurons(nmPeakSigMat,odors2exclude_idx,ORNs2use)

compiled_data=load('compiled_data.mat');
training_data=prepare_data4classifier(compiled_data);
[test_data,nmPeakSigMatTest]=prepare_test_data(nmPeakSigMat,odors2exclude_idx);
